...
$AllTextPostInfoSQL ="SELECT P.PostID, ProfileID, PageID, TContent, CreationDate FROM Post as P JOIN  Text as T ON P.PostID = T.PostID";
...
/* ------------TEXT----------------------*/
  if($AdminPgInfo->execute()){
      ...
      $AdminPgInfo->bind_result($PostID,$ProfileID,$PageID,$TContent,$CreationDate);
